...
from ChanAnalyse.Common.func_util import check_kltype_order, kltype_lte_day
...
class CChan:
    ...
    def GetStockAPI(self):
        ...
        if self.data_src == DATA_SRC.BAO_STOCK:
            ...
            from ChanAnalyse.DataAPI.ccxt import CCXT
            _dict[DATA_SRC.CCXT] = CCXT
        elif self.data_src == DATA_SRC.CSV:
            from ChanAnalyse.DataAPI.csvAPI import CSV_API
            _dict[DATA_SRC.CSV] = CSV_API
        elif self.data_src == DATA_SRC.AKSHARE:
            from ChanAnalyse.DataAPI.AkshareAPI import CAkshare
        ...
        import importlib
        module = importlib.import_module(f"ChanAnalyse.DataAPI.{package_name}")
