...
用法：
    python Data/intraday_poll.py --config ingest_config.json --pg-dsn "host=... dbname=..."
    python Data/intraday_poll.py --config ingest_config.json --once     # 单轮（测试/手动补拉）
"""
...
from ChanAnalyse.DataAPI.IngestUtil import iter_ingest_jobs, klu_to_row, load_config, validate
from ChanAnalyse.DataAPI.KLineStore import KLineStore, DEFAULT_DB_PATH
from ChanAnalyse.DataAPI.RecomputeCursor import MemoryCursor, RecomputeCursor
...
def main(argv=None):
    ...
    from ChanAnalyse.DataAPI.MinuteAPI import CMinute
